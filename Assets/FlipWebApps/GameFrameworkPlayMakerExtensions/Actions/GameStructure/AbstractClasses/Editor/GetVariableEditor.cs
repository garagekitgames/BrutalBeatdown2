...
namespace GameFrameworkPlayMakerExtensions.Actions.GameStructure.AbstractClasses.Editor
{
    ...
    /// </summary>
    public class GetVariableEditor : CustomActionEditor
    {
        public override bool OnGUI()
        {
            var action = target as GetVariable;
